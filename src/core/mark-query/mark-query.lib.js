...
/** 
 * MarkQuery is a minimalistic library for handing API requests. 
 * Fetch data from the API with provided options. 
 * 
 * @param {Object} options - configurations options for the API requests. 
 ...
 * @param {Function} [options.onSuccess=null] - Callback function t obe called on successful response.   
 * @param {Function} [options.onError=null] - Callback function t obe called on error response.
